...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=".",
        help="Path to the project directory to scan. Defaults to the current directory.",
    )
    parser.add_argument(
        "-o",
        "--output",
        default="README_DRAFT.md",
        help="Output README draft path. Defaults to README_DRAFT.md in the current working directory.",
    )
    parser.add_argument(
        "--title",
        default=None,
        help="Override the generated project title.",
    )
    parser.add_argument(
        "--stdout",
        action="store_true",
...
def main(argv: list[str] | None = None) -> int:
    ...
    readme = generate_readme(scan, profile, title=args.title)
